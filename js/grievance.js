...
### [접수 예시 – 약 200자]
A직원은 최근 특정 시간대 업무량이 지속적으로 집중되면서 과도한 부담을 느끼고 있다고 고충을 제기하였다. 특히 점심 이후 위생·정리 업무가 반복적으로 단독 배정되어 업무 균형이 무너진 상황이라고 진술하였다. 또한 동료 직원과의 역할 조정이 충분히 이루어지지 않아 협업이 원활하지 않은 점도 어려움으로 표현하였다.

### [분석 예시 – 약 300자]
근무표와 해당조 직원 면담을 통해 확인한 결과, 최근 신입 직원의 적응 기간으로 인해 특정 업무가 A직원에게 과도하게 배정되는 날이 있었다. 동료 직원 또한 이러한 업무 불균형을 인지하고 있었으나, 바쁜 시간대에는 역할 조율이 충분히 이루어지지 못한 상황이었다고 설명하였다. 기관은 접수된 고충과 사실 확인을 바탕으로 배치 조정과 역할 명확화가 필요하다고 판단하였다. 특히 위생·정리 업무가 특정 직원에게 집중되는 패턴이 반복되는지 추가 확인이 필요함을 파악하였다.

### [조치 예시 – 약 150자]
기관은 동일 시간대 역할 분담을 명확히 조정하고 위생·정리 업무가 단일 직원에게 집중되지 않도록 근무표를 재배치하였다. 또한 신입 직원에게 관련 업무 절차를 추가 교육하여 전체 부담이 고르게 분배되도록 조치하였다.

### [통보 예시 – 약 150자]
A직원에게 근무표 조정 내용과 역할 분담 개선사항을 대면으로 자세히 안내하였다. 직원은 변경된 근무 흐름이 도움이 될 것 같다고 답하였으며, 향후 상황을 함께 점검하자는 기관의 제안에도 동의하였다.

### [사후관리 예시 – 약 200자]
기관은 향후 2주간 해당 시간대의 업무 배분과 직원 간 협력 흐름을 집중적으로 확인하기로 하였다. A직원과는 주 1회 간단한 체크인을 진행해 업무 피로도와 부담감을 점검하며, 문제 발생 시 즉시 조정할 예정이다. 또한 조정된 근무표가 전체 직원에게 균형 있게 적용되는지 모니터링해 추가 개선 필요 여부를 검토하기로 하였다.
