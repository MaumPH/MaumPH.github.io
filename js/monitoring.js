...
4. 요양쌤 모니터링 (100자 이내) - 프로그램 진행 중 요양쌤이 관찰하고 도운 내용
...
[4]
프로그램 진행 중 활동 방법을 설명해드리니 대칭 막대기를 선택하여 배치하는 모습을 확인함. 활동 시간 동안 큰 어려움 없이 참여하였으며, 필요할 때 간단히 알려드리며 프로그램을 잘 마무리할 수 있도록 도움드림
...
[2]
보행 시 낙상 위험이 있어 이동 구간 정리 및 미끄럼 방지 조치 필요함. 식사 시 천천히 드시도록 말씀드리고, 오후 시간대 충분한 휴식을 드릴 필요가 있음
...
3. **상황 세부화**: 구체적인 상황, 시간, 행동을 다양하게 조합
4. **감정 표현 세분화**: 긍정도 "기쁨/만족/자랑스러움/흥미" 등 세밀하게 구분
5. **시간 흐름 변화**: 프로그램 초반/중반/후반의 변화를 다양하게 묘사
6. **참여 방식 다각화**: 적극적/소극적/관망/부분참여 등 다양한 참여 형태
7. **관찰 가능한 디테일**: 표정, 손동작, 자세, 시선, 신체 반응 등 실제 관찰 내용 중심

**금지 사항:**
- 이전에 생성한 것과 유사한 표현 사용 금지
- 기계적으로 반복되는 패턴 금지
- 추상적 표현보다는 생생한 구체적 관찰 우선
- 관찰하기 어려운 구체적 대화 내용이나 말씀은 최소화
...
# 실제 관찰 느낌의 표현
추상적 표현보다 관찰 가능한 구체적 행동 중심:
- ❌ "좋아하심" → ✅ "박수 치시며 환한 표정 지으심"
- ❌ "열심히 함" → ✅ "땀 흘리시며 끝까지 집중하심"
- ❌ "즐거워함" → ✅ "밝게 웃으시며 고개 끄덕이심"
- ❌ "어려워함" → ✅ "고개 갸우뚱하시며 손을 멈추심"
- ❌ "만족함" → ✅ "완성된 작품을 바라보며 미소 지으심"
- ❌ "피곤함" → ✅ "중간에 쉬시며 어깨 두드리심"
...
# 작성 규칙
1. 존댓말 "~하심" 형태로 작성
2. **각 반응은 30자 이상 작성 (구체적 상황, 세부 동작, 표정 변화, 신체 반응 등 포함)**
...
7. **관찰 가능한 디테일**: 표정 변화, 손동작, 자세, 시선, 참여 태도 등 실제 관찰 내용 중심
8. **감정 표현 다양화**: 같은 긍정이라도 "기쁨/흥미/만족/자랑스러움/뿌듯함/안도감" 등 세분화
9. **⭐ 매번 새로운 조합**: 어휘·문장구조·상황·시간대·참여 방식을 매번 다르게 조합
10. **창의적 변주**: 같은 감정도 다양한 맥락과 표현으로 (예: 기쁨 → 웃음/박수/표정/몸짓/고개끄덕임 등)
